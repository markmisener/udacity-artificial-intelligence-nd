...
A: We created two additional units to act as the diagonal values of the grid and
added these units to the existing constraints. We applied the constraints until
the solution was solved or stalled.
